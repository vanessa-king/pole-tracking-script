...
jythonText_2 = File.openAsString(getDirectory("home") +"Desktop/Tracking Script/Jython Script/Part_2_Cin8.py");
...
waitForUser("List", "Please select 'List' on the Profiles window then click OK.");
selectWindow("Plot Values");
saveAs('text', directory+cell+"_results.txt");
selectWindow("Profiles");
run("Close");
selectWindow(cell+"_results.txt");
run("Close");
...
run("Close");
selectWindow("C2-"+cell+"-1.tif");
run("Close");
selectWindow("C1-"+cell+"-1.tif");
run("Close");
